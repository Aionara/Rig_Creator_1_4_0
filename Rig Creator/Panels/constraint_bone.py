...
class RGC_List_ConstraintsBone(GeneralArmatureData, bpy.types.UIList):
...
class RGC_Panel_Bone_Constraint(BoneConstraintPanel,GH_RGC_DrawListConstraint, bpy.types.Panel):
    bl_idname = "RGC_Panel_Bone_Constraint"
    ...
    def poll(cls, context):
        return (
            context.pose_bone and context.active_pose_bone
        )
    
    def draw(self, context):
        layout = self.layout
        self.Draw(context, use_bone=True)
